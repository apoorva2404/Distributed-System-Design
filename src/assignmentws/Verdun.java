...
public class Verdun {
	public static void main(String[] args) throws SecurityException, IOException {
        LoggerClass logInfo = new LoggerClass("VedunServer" + ".txt");

        logInfo.logger.setLevel(Level.ALL);

        BookingImplementation ver = new BookingImplementation("VER", logInfo);
        ...
        Thread UDPCommunicator = new Thread(){
            public void run() {           
                ...
                while(true) {
                    ...
                    result = ver.mapFunction(str, logInfo);
    ...
    UDPCommunicator.start();
        logInfo.logger.info("Verdun service is published: " + endpoint.isPublished());
	}
